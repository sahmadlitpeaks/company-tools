...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b transition-colors hover:bg-table-row-hover has-aria-expanded:bg-table-row-hover data-[state=selected]:bg-muted data-[state=selected]:hover:bg-muted",
        className
      )}
      {...props}
    />
